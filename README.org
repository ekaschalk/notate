...
- The core idea!
  - Toggling on/off works as expected.
  - Deleting any part of a note updates indentation on-the-fly.
  - Deleting near the beginning of masked lines behaves as if not masked.
- Line movement user commands use /visual-columns/ rather than true columns.
  - Accounts for EOLs properly.

*** Whats Being Worked On

- Tests for masking line movement/visual column concept.
