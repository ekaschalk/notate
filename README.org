* Notate.el - Program with Personalized Notation
...
- Similar work? :: Notate is a novel extension of the concept of
                   ...
                   ~vim-conceal~. Note nt is self-contained and cannot leverage
...
~pretty-symbols~ is also unique to Emacs and not widely known.

*So I have chosen to shift discourse of this concept from "prettifying" to
"notating" programming buffers.*
