...
- Buffer modification that adds or removes lines.
  - Balanced insertion/deletion appear to be good.
  - Unbalanced insertion/deletion also /appears/ to be good but will be likely
    hard to think through all the cases to confirm this and to optimize it.
...
- The how long a masked indent goes is only major-mode agnostic when support for
  buffer-modification is not enabled.
