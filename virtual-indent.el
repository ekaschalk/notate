...
(defconst virtual-indent-rgx-string-alist
  '(("\\(hello\\)" ""))
  "Alist of rx and string replacement.")
...
;; https://www.gnu.org/software/emacs/manual/html_node/elisp/Truncation.html#Truncation
;; `line-prefix' and `wrap-prefix' used by org-indent
